...
<body>
    <?php
        ...
        $verificar = mysqli_query($conexion,"SELECT *FROM estudiante WHERE ndo_apr = '$numero_doc'");
        ...
        $sql = "INSERT INTO estudiante (nom_apr, ape_apr, tdo_apr, ndo_apr, tel_apr, fot_apr) VALUES (
            '{$_REQUEST['nombre-usuario']}',
            '{$_REQUEST['apellido-usuario']}',
            '{$_REQUEST['tipo-documento']}',
            '{$_REQUEST['numero-doc']}',
