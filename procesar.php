...
<body>
    <?php
        ...
        $verificar = mysqli_query($conexion,"SELECT *FROM aprendiz WHERE ndo_apr = '$numero_doc'");
        ...
        $sql = "INSERT INTO aprendiz (nom_apr, ape_apr, tdo_apr, ndo_apr, tel_apr, fot_apr) VALUES (
